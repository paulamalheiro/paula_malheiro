    ...
    <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
      ...
      <div className="relative">
        <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl relative">
          <img src={getImageUrl('/velli.jpeg')} alt="Investimento" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
        </div>
        <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-2xl shadow-xl max-w-xs border border-gray-100">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-primary/20 relative overflow-hidden">
              <img src={getImageUrl('/velli.jpeg')} alt="Paula Malheiro" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
            <div>
...
const About = () => (
  <section id="about" className="py-24 bg-white">
    <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-start">
      ...
      >
        <img 
          src={getImageUrl('/paula-perfil.jpeg')} 
          alt="Paula Malheiro" 
          width={800}
          height={1000}
