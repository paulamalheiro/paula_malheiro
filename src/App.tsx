    ...
    <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
      ...
      <div className="relative">
        <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl relative">
          <img src="/velli_v2.jpeg" alt="Investimento" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
        </div>
        <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-2xl shadow-xl max-w-xs border border-gray-100">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-primary/20 relative overflow-hidden">
              <img src="/velli_v2.jpeg" alt="Paula Malheiro" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
            <div>
  ...
  <section id="construction" className="py-24 bg-white">
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        {[
          { label: 'Bellator', img: '/bellator_v2.jpeg' },
          { label: 'Amado', img: '/amado_v2.jpeg' },
          { label: 'Verso', img: '/verso_v2.jpeg', link: 'https://www.instagram.com/reel/DT8XsQojhti/?igsh=MThyOHU0eWQ4ajNhaw==' },
          { label: 'Baron', img: '/baron_v2.jpeg' },
          { label: 'Sculptor', img: '/sculptor_v2.jpeg' },
          { label: 'Uni', img: '/uni_v2.jpeg', link: 'https://www.instagram.com/reel/DWWQfOYDuAn/?igsh=MXFlamt6aGZlZWFndQ==' },
          { label: 'Vila', img: '/vila_v2.jpeg' }
        ].map((item, idx) => {
